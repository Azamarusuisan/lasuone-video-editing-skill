...
Evidence currently means a 189-video public census (59 ordinary, 130 Shorts), 188 acquired research copies, ASR candidates for 188 videos, machine scene scans and overview captures for all 188 copies, partial observation of 137 videos, 111 whole-duration sparse reviews, zero videos certified as fully reviewed, and 114 subtitle-frame samples with repeated holds possible. Counts are from `evidence/COVERAGE.json` compiled at `2026-09-15T04:12:43.674Z`; that evidence file is not bundled. It does not mean 137 full videos, 188 verified transcripts, or 114 independent subtitle events. Four long Las Vegas compilations remain pending full-length review. Direct BGM/SE listening, calibrated subtitle/font/color measurements, cut/pause/reaction timing, and export settings remain incomplete. One age-gated video is unavailable; do not bypass access restrictions.
